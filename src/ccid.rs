...
use ccid_firmware_rs::ccid_core::{
    CcidMessageHandler, CCID_HEADER_SIZE, PACKET_SIZE, REQUEST_ABORT,
    REQUEST_GET_CLOCK_FREQUENCIES, REQUEST_GET_DATA_RATES,
};
use ccid_firmware_rs::device_profile::CURRENT_PROFILE;

const CLASS_CCID: u8 = 0x0B;
const DESCRIPTOR_TYPE_CCID: u8 = 0x21;
const SUBCLASS_NONE: u8 = 0x00;
const PROTOCOL_BULK: u8 = 0x00;
...
pub use ccid_firmware_rs::ccid_core::{
    SlotState, CCID_ERR_CMD_ABORTED, CCID_ERR_CMD_NOT_SUPPORTED, CCID_ERR_CMD_SLOT_BUSY,
    CCID_ERR_HW_ERROR, CCID_ERR_ICC_MUTE, CCID_ERR_PIN_CANCELLED, CCID_ERR_PIN_TIMEOUT,
    ...
    PC_TO_RDR_ESCAPE, PC_TO_RDR_GET_PARAMETERS, PC_TO_RDR_GET_SLOT_STATUS, PC_TO_RDR_ICC_CLOCK,
