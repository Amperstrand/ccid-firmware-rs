...
#[cfg(all(
    any(feature = "stm32f469", feature = "stm32f746"),
    target_arch = "arm",
    target_os = "none"
))]
...
fn main() -> ! {
    ...
    // =========================================================================
    // GPIO + Smartcard driver (target-specific)
    // =========================================================================
    ...
    // Kept inline deliberately (amp-embedded-common dissolved 2026-08-31 per necessity audit; see .omo/evidence/amp-necessity-audit.md).
